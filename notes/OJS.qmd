...
I was working on a bar graph in OJS and it take over a minute of the graph display. The reason–I had the graph in a tab setting–so it was confused when to render. I moved to the first tab and it worked fine.